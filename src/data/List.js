...
export const albumItem = [
  {
    id: 4,
    name: "ZX9 SPEAKER",
    img: img_speaker_album,
    navigate: "/Product",
    svg: img_pattern_circles_lg,
...
export const product_headphone = [
  ...
  },
  {
    ...
    img: HEADPHONES2,
    isNew: false,
    desc: "As the gold standard for headphones, the classic XX99 Mark I offers detailed and accurate audio reproduction for AudioSphere, mixing engineers, and music aficionados alike in studios and on the go.",
  },
  {
    id: 9,
    delay: 0.5,
...
export const product_speaker = [
  {
    ...
    img: SPEAKER1,
    isNew: false,
    desc: "Stream high quality sound wirelessly with minimal to no loss. The ZX7 speaker uses high-end AudioSphere components that represents the top of the line powered speakers for home or studio use.",
  },
  {
    id: 11,
    name: "ZX9 SPEAKER",
